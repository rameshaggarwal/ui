...
export default buildRoutes(function() {
  ...
  this.route('delta-dashboard', { path: '/delta-dasbhoard' }, function() {
    this.route('index', { path: '/' });
  });

  this.route('delta-tasks', { path: '/delta-tasks' }, function() {
    this.route('index', { path: '/' });
  });

  this.route('delta-history', { path: '/delta-history' }, function() {
    this.route('index', { path: '/' });
  });
